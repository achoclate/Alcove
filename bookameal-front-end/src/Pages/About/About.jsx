    ...
    <div className="about-content">
      <div className="about-content_about">
        ...
        <p className="paragraph">
          The Alcove is a charming, intimate nook within the restaurant that
          offers a secluded and cozy dining experience. It’s the perfect spot
          for diners seeking a touch of privacy while enjoying their meal,
      ...
      <div className="about-content_history">
        ...
        <p className="paragraph">
          Nestled in the heart of our bustling city, The Alcove began as a dream
          to create a sanctuary of tranquility amid the lively rhythm of urban
          life. Established in 2024, The Alcove emerged from a passion for
          crafting not just meals, but moments of serene indulgence. From its
          humble beginnings as a modest dining space, it has grown into a
          beloved retreat known for its intimate and cozy atmosphere. Inspired
          by the concept of a secluded hideaway, The Alcove was designed to
          offer diners a touch of privacy and a respite from the everyday
          hustle. Every corner of the restaurant reflects a commitment to
          creating a peaceful ambiance, where the art of dining is elevated by a
